...
namespace QuanLyQuanCaFe {
    ...
    public partial class QuanlycafeDataSet : global::System.Data.DataSet {
        ...
        public partial class FoodDataTable : global::System.Data.TypedTableBase<FoodRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FoodRow AddFoodRow(string name, double price, int idCategory) {
...
namespace QuanLyQuanCaFe.QuanlycafeDataSetTableAdapters {
    ...
    public partial class FoodTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Food] WHERE (([id] = @Original_id) AND ([name] = @Original_nam" +
                "e) AND ([price] = @Original_price) AND ([idCategory] = @Original_idCategory))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Food] ([name], [price], [idCategory]) VALUES (@name, @price, @" +
                "idCategory);\r\nSELECT id, name, price, idCategory FROM Food WHERE (id = SCOPE_IDE" +
                "NTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Food] SET [name] = @name, [price] = @price, [idCategory] = @idCategory WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([price] = @Original_price) AND ([idCategory] = @Original_idCategory));
SELECT id, name, price, idCategory FROM Food WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, price, idCategory FROM dbo.Food";
        ...
        public virtual int Delete(int Original_id, string Original_name, double Original_price, int Original_idCategory) {
        ...
        public virtual int Insert(string name, double price, int idCategory) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, double price, int idCategory, int Original_id, string Original_name, double Original_price, int Original_idCategory, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, double price, int idCategory, int Original_id, string Original_name, double Original_price, int Original_idCategory) {
            return this.Update(name, price, idCategory, Original_id, Original_name, Original_price, Original_idCategory, Original_id);
        }
    }
